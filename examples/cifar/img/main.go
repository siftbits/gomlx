...
import (
	...
	_ "github.com/gomlx/gomlx/backends/simplego" // Default backend, which uses GOMLX_BACKEND if set.
	"github.com/gomlx/gomlx/examples/cifar"
	"github.com/gomlx/gomlx/types/tensors/images"
	"github.com/gomlx/gopjrt/dtypes"
)

var flagDataDir = flag.String("data", "~/work/cifar", "directory to hold downloaded CIFAR data in")
